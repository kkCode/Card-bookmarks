...
如果无法打开 Webstore 链接，也可以在[这里](https://github.com/kkCode/Card-bookmarks/files/1660153/card_bookmarks.zip)下载，下载完成后解压，然后在浏览器打开 chrome://extensions/，拖动解压文件夹里的 crx 文件到这个页面进行安装
